...
def noticias2(request):
    ...
    return render (request, 'core/noticias2.html', data)
...
def subir_imagen(request):
    ...
    if request.method == 'POST':
        ...
        if not imagen:
            ...
            return render(request, 'intranet/gestion_galeria.html', data)
...
def gestion_disciplina(request):
    disciplinas = listado_disciplinas()  # Asumiendo que esta función ya está definida
